...
case. The following is the output from the highschool model:
    ...
    Using file: /tmp/RtmpHXAiFe/file534f7deffb4d.yaml
    ...
    Total elapsed t     : 613.00ms (2000 runs)
    Last run speed      : 11.48 million agents x day / second
    Average run speed   : 120.06 million agents x day / second
    Rewiring            : off
