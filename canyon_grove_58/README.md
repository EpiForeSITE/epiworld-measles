...
case. The following is the output from the highschool model:
    ...
    Using file: /tmp/RtmpXTQvxr/filecf1e369ae3d2.yaml
    ...
    Total elapsed t     : 681.00ms (2000 runs)
    Last run speed      : 12.15 million agents x day / second
    Average run speed   : 114.50 million agents x day / second
    Rewiring            : off
