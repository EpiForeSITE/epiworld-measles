...
case. The following is the output from the highschool model:
    ...
    Using file: /scratch/local/u6039184/3491631/RtmppDY81D/file2f31314115f7cb.yaml
    ...
    Last run speed      : 4.39 million agents x day / second
    Average run speed   : 43.87 million agents x day / second
    Rewiring            : off
