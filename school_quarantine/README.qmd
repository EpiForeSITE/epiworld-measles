...
#| echo: false
#| label: run-model
system2("./school_quarantine.o", "params.yaml", wait = TRUE, stdout=TRUE) |>
    cat(sep = "\n")
```
...
fwrite(histories_wide, "school_quarantine-histories.csv")
...
fwrite(detected, "school_quarantine-detected.csv")
```
