...
case. The following is the output from the highschool model:
    ...
    Using file: /tmp/RtmpPL2Hgi/filea5e6b337ac9.yaml
    ...
    Total elapsed t     : 522.00ms (2000 runs)
    Last run speed      : 13.22 million agents x day / second
    Average run speed   : 108.77 million agents x day / second
    Rewiring            : off
