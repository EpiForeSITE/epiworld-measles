...
case. The following is the output from the highschool model:
    ...
    Using file: /scratch/local/u6039184/3564212/Rtmp8UgcuN/file42fcc711ee284.yaml
    ...
    Last run speed      : 5.16 million agents x day / second
    Average run speed   : 50.67 million agents x day / second
    Rewiring            : off
